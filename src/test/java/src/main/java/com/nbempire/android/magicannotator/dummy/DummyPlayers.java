...
public abstract class DummyPlayers {
    ...
    public static List<Player> forTruco1() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        return players;
    }

    public static List<Player> forTruco2() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
    ...
    public static List<Player> forTruco3() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        players.add(new Player("Fer"));
    ...
    public static List<Player> forTruco5() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        players.add(new Player("Fer"));
    ...
    public static List<Player> forTruco7() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        players.add(new Player("Fer"));
        players.add(new Player("Clausi"));
    ...
    public static List<Player> forTute4() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        players.add(new Player("Fer"));
        players.add(new Player("Mati"));
    ...
    public static List<Player> forTute5() {
        List<Player> players = new ArrayList<Player>();
        players.add(new Player("Nahuel"));
        players.add(new Player("Fer"));
        players.add(new Player("Mati"));
