...
public class TrucoServiceImplUnitarioTest {
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TrucoServiceImpl#getFirstTeamLabel()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TrucoServiceImpl#getSecondTeamLabel()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TrucoServiceImpl#getTeamPlayersLimit(int)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TrucoServiceImpl#hasValidNumberOfSelectedPlayers()}
     * .
     */
    @Test
    public final void testHasValidNumberOfSelectedPlayers_withValidSelectedPlayers_returnTrue() {
        Assert.assertTrue("Con 2 jugadores seleccionados, debería haber retornado <true>",
                          instance.hasValidNumberOfSelectedPlayers(2));
        Assert.assertTrue("Con 4 jugadores seleccionados, debería haber retornado <true>",
    ...
    public final void testHasValidNumberOfSelectedPlayers_withInvalidSelectedPlayers_returnFalse() {
        ...
        Assert.assertFalse("Con 3 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(3));
        Assert.assertFalse("Con 5 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(5));
        Assert.assertFalse("Con 7 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(7));
    }

    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TrucoServiceImpl#getInvalidNumberOfSelectedPlayersExceptionMessage(com.nbempire.android.magicannotator.domain.game.Game)}
     * .
     */
    @Test
