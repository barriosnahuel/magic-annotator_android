...
import com.nbempire.android.magicannotator.dummy.DummyPlayers;
...
public class TuteServiceImplUnitarioTest {
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TuteServiceImpl#getFirstTeamLabel()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TuteServiceImpl#getSecondTeamLabel()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TuteServiceImpl#getTeamPlayersLimit(int)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TuteServiceImpl#hasValidNumberOfSelectedPlayers(int)}
     * .
     */
    @Test
    public final void testHasValidNumberOfSelectedPlayers_withValidSelectedPlayers_returnTrue() {
        Assert.assertTrue("Con 3 jugadores seleccionados, debería haber retornado <true>",
                          instance.hasValidNumberOfSelectedPlayers(3));
        Assert.assertTrue("Con 6 jugadores seleccionados, debería haber retornado <true>",
                          instance.hasValidNumberOfSelectedPlayers(6));
        Assert.assertTrue("Con 7 jugadores seleccionados, debería haber retornado <true>",
                          instance.hasValidNumberOfSelectedPlayers(7));
        Assert.assertTrue("Con 8 jugadores seleccionados, debería haber retornado <true>",
                          instance.hasValidNumberOfSelectedPlayers(8));
        Assert.assertTrue("Con 12 jugadores seleccionados, debería haber retornado <true>",
    ...
    public final void testHasValidNumberOfSelectedPlayers_withInvalidSelectedPlayers_returnFalse() {
        Assert.assertFalse("Con 1 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(1));
        Assert.assertFalse("Con 2 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(2));
        Assert.assertFalse("Con 13 jugadores seleccionados, debería haber retornado <false>",
                           instance.hasValidNumberOfSelectedPlayers(13));
    }

    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.TuteServiceImpl#getInvalidNumberOfSelectedPlayersExceptionMessage()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.GameServiceImpl#makeTeams(java.util.List)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.nbempire.android.magicannotator.service.impl.GameServiceImpl#getExpandableTeams(java.util.List)}
     * .
     */
    @Test
    @Ignore
